...
{/* MEMBERSHIP & AD-FREE UNLOCK */}
        ...
        <View style={[styles.groupedCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={[styles.groupedCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <Pressable
              style={({ pressed }) => [styles.rowItem, pressed && styles.pressedRow]}
              onPress={() => router.push('/health-tools')}
            >
              <View style={[styles.rowIconCircle, { backgroundColor: colors.surface }]}>
                <Ruler size={18} color={colors.activity} />
              </View>
              <View style={styles.rowTextCol}>
                <Typography variant="bodyMedium" style={styles.rowTitle}>Health Tools & Calculators</Typography>
                <Typography variant="caption" color={colors.subtext}>
                  BMI, BMR, TDEE, Macros, Hydration
                </Typography>
              </View>
              <ChevronRight size={18} color={colors.subtext} />
            </Pressable>
          ...
          <View style={[styles.groupedCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            >
              ...
              <View style={styles.rowTextCol}>
                <Typography variant="bodyMedium" style={styles.rowTitle}>App Settings</Typography>
                <Typography variant="caption" color={colors.subtext}>
                  Theme, Notifications, Languages
                </Typography>
              </View>
              <ChevronRight size={18} color={colors.subtext} />
            </Pressable>
